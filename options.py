...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--batch_size', type=int, default=18, help='batch size')
    ...
    # ouptput related
    self.parser.add_argument('--name', type=str, default='HSENet', help='folder name to save outputs')
...
class TestOptions():
  def __init__(self):
    ...
    ## mode related
    self.parser.add_argument('--class_nb', type=int, default=9, help='class number for segmentation model')
    self.parser.add_argument('--resume', type=str, default='./results/HSENet/checkpoints/best_model.pth', help='specified the dir of saved models for resume the training')
    self.parser.add_argument('--gpu', type=int, default=0, help='GPU id')
